...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* ✅ THÊM STYLE CHO NÚT CẤU HÌNH (Màu Cam hoặc Tím đậm) */
            .config-btn {
                background: #ff9f43; /* Màu cam nổi bật */
                color: white;
            }

            /* Hiệu ứng hover giống các nút khác */
            .config-btn:hover {
                opacity: 0.8;
                transform: scale(1.05);
            }
                                ...
                                <tr style="animation-delay: ${i.index * 0.05}s;">
                                    ...
                                    <td>
                                        <div class="action-btns">
                                            <a href="editProduct.jsp?id=${p.productId}" class="edit-btn" title="Sửa thông tin chung">
                                                <i class="fas fa-edit"></i> Sửa
                                            </a>

                                            <a href="${pageContext.request.contextPath}/admin/manageConfig?id=${p.productId}" 
                                               class="config-btn" 
                                               title="Chỉnh sửa linh kiện (CPU, RAM...)">
                                                <i class="fas fa-microchip"></i> Cấu hình
                                            </a>

                                            <a href="${pageContext.request.contextPath}/admin/productManagement?action=delete&id=${p.productId}"
                                               onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này?');"
                                               class="delete-btn" title="Xóa sản phẩm">
